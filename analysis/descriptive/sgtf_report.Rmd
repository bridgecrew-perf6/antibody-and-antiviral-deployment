...
tbls1$table_body$stat_0 = ifelse(str_extract(string = tbls1$table_body$stat_0, pattern = "[0-9]+") > 0 &
  str_extract(string = tbls1$table_body$stat_0, pattern = "\\d+") < threshold, "<8", tbls1$table_body$stat_0)
...
tbls2$table_body$stat_0 = ifelse(str_extract(string = tbls2$table_body$stat_0, pattern = "\\d+") > 0 &
  str_extract(string = tbls2$table_body$stat_0, pattern = "\\d+") < threshold, "<8", tbls2$table_body$stat_0)
...
tbls1$table_body$stat_0 = ifelse(str_extract(string = tbls1$table_body$stat_0, pattern = "\\d+") > 0 &
  str_extract(string = tbls1$table_body$stat_0, pattern = "\\d+") < threshold, "<8", tbls1$table_body$stat_0)
