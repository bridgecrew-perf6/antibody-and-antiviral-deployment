...
tbls1$table_body$stat_0 = ifelse(as.numeric(str_extract(string = tbls1$table_body$stat_0, pattern = "[0-9]+")) > 0 &
  as.numeric(str_extract(string = tbls1$table_body$stat_0, pattern = "[0-9]+")) < threshold, "<8", tbls1$table_body$stat_0)
...
tbls2$table_body$stat_0 = ifelse(as.numeric(str_extract(string = tbls2$table_body$stat_0, pattern = "[0-9]+")) > 0 &
  as.numeric(str_extract(string = tbls2$table_body$stat_0, pattern = "[0-9]+")) < threshold, "<8", tbls2$table_body$stat_0)
